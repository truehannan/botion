  ...
  return (
    <div className="my-4 rounded-lg border border-neutral-100 dark:border-neutral-800">
      <div className="flex items-center gap-1 border-b border-neutral-100 px-3 py-2 dark:border-neutral-800">
        ...
        <button className="ml-auto rounded p-1 text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800"><Plus className="h-3.5 w-3.5" /></button>
      </div>
      <div className="min-h-[12rem]">
        {activeView ? <ActiveView type={activeView.type} /> : <div className="p-8 text-center text-xs text-neutral-400">No views configured.</div>}
      </div>
    </div>
  );
}
