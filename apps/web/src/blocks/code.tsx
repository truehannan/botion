...
const LANGUAGES = [
  ...
  'kotlin', 'sql', 'html', 'css', 'json', 'yaml', 'markdown',
  'bash', 'powershell', 'lua', 'perl', 'r', 'dart',
];
      ...
      return (
        <div className="group relative rounded-lg bg-neutral-100 dark:bg-neutral-800/60">
          <div className="flex items-center justify-between px-3 py-1.5">
            <select
              ...
              onChange={(e) => {
                ...
                editor.updateBlock(block, { props: { language: e.target.value } });
              }}
          ...
          <div className="px-3 pb-3">
            <pre data-language={lang} className="!bg-transparent !p-0">
              <code className={`language-${lang}`} ref={contentRef} />
            </pre>
          </div>
        </div>
      );
